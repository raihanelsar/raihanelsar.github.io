        ...
        <div class="table-responsive shadow-sm rounded">
            <table class="table table-bordered table-hover align-middle">
                ...
                <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php if (!empty($row['link'])): ?>
                                        <a href="<?= htmlspecialchars($row['link']) ?>" target="_blank" class="btn btn-outline-primary btn-sm">🔗
                                            Lihat</a>
                                    <?php else: ?>
                                        <span class="text-muted">-</span>
                                    <?php endif; ?>
                                ...
                                <td class="text-center">
                                    <a href="?page=tambah-portfolio&edit=<?= intval($row['id']) ?>" class="btn btn-success btn-sm">✏ Edit</a>
                                    <a href="?page=portfolio&del=<?= $row['id'] ?>" class="btn btn-danger btn-sm"
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="8" class="text-center text-muted">Belum ada data portfolio</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
